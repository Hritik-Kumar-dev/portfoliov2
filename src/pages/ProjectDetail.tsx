  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg2)', color: 'var(--text)' }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-5">
        ...
        {/* Extra details */}
        {project.details && (
          <div className="mb-4 rounded-md p-5" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
        ...
        <div className="rounded-md p-5" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
          ...
          <div className="flex flex-wrap gap-2">
            {project.tags.map(tag => (
              <span key={tag} className="font-mono text-xs px-2.5 py-1 rounded-sm"
                style={{ background: 'transparent', border: '1px solid var(--border)', color: 'var(--text-bright)' }}>
                {tag}
              </span>
            ))}
